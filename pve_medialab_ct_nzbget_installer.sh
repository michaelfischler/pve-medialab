#!/usr/bin/env bash
# ----------------------------------------------------------------------------------
# Filename:     pve_medialab_ct_nzbget_installer.sh
# Description:  Installer script for Proxmox Nzbget Server
# ----------------------------------------------------------------------------------
...
#---- Source local Git
# /mnt/pve/nas-01-git/ahuacate/pve-medialab/pve_medialab_ct_nzbget_installer.sh
...
GIT_APP_SCRIPT='pve_medialab_ct_nzbget.sh'
